...
class _HomeNotificationsState extends State<HomeNotifications> {
  ...
  String currentPageName = 'HomeNotifications';
  ...
  Widget build(BuildContext context) {
    ...
    GlobalKey<ScaffoldState> homeNotificationsKey = GlobalKey<ScaffoldState>();
    return Scaffold(
        key: homeNotificationsKey,
              ...
              SliverAppBar(
                ...
                actions: [
                  IconButton(
                    ...
                    onPressed: () {
                      homeNotificationsKey.currentState?.openEndDrawer();
                    },
                  ),
                ],
...
class HomeNotificationsBody extends StatefulWidget {
  const HomeNotificationsBody(
      {super.key,
        required this.title,
        required this.routeManager,
        required this.appRepository,
  ...
  @override
  State<HomeNotificationsBody> createState() => _HomeNotificationsBody();
}

class _HomeNotificationsBody extends State<HomeNotificationsBody> {
  int _counter = 0;
  ...
  @override
  Widget build(BuildContext context) {
    GlobalKey<ScaffoldState> homeNotificationsBodyKey = GlobalKey<ScaffoldState>();
    return Center(
      key: homeNotificationsBodyKey,
      child: Column(
