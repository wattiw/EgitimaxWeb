...
class _HomeNetworkState extends State<HomeNetwork> {
  ...
  String currentPageName = 'HomeNetwork';
  ...
  Widget build(BuildContext context) {
    ...
    GlobalKey<ScaffoldState> homeNetworkKey = GlobalKey<ScaffoldState>();
    return Scaffold(
        key: homeNetworkKey,
              ...
              SliverAppBar(
                ...
                actions: [
                  IconButton(
                    ...
                    onPressed: () {
                      homeNetworkKey.currentState?.openEndDrawer();
                    },
                  ),
                ],
...
class _HomeNetworkBody extends State<HomeNetworkBody> {
  int _counter = 0;
  ...
  @override
  Widget build(BuildContext context) {
    GlobalKey<ScaffoldState> homeNetworkBodyKey = GlobalKey<ScaffoldState>();
    return Center(
      key: homeNetworkBodyKey,
      child: Column(
