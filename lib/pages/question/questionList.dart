...
class QuestionList extends StatefulWidget {
  const QuestionList({super.key, required this.userId});
  final BigInt userId;
...
class _QuestionListState extends State<QuestionList> {
  ...
  void initState() {
    super.initState();
    startId=BigInt.parse('0');
    endId=BigInt.parse('1000');
    loadDefaults();
  }

  Future<void> loadDefaults()
  async {
   var pageCount= await appRepository.getAllWithPageCountViewQueQuestionMain(widget.userId,currentPerPage);
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<ViewQueQuestionMain>>(
      future: appRepository.getAllWithPageViewQueQuestionMain(widget.userId, currentPerPage, currentPage),
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return ResponsiveDatatableHelper(
            ...
            headers: [
              ...
              DatatableHeader(text: "Grade", value: "GradeName", show: true, sortable: true, textAlign: TextAlign.center),
              ...
              DatatableHeader(text: "Learn", value: "LearnNameChain", show: true, sortable: true, textAlign: TextAlign.center),
              DatatableHeader(text: "Location", value: "LocationNameChain", show: true, sortable: true, textAlign: TextAlign.center),
